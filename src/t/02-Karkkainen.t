...
#50 34 36 33 35 39 41 37 6 20 25 19 24 28 14 8 32 43 18 1 48 40 4 2 46 42 49 27 31 44 21 12 23 45 22 38 5 3 30 29 15 9 13 7 17 0 47 26 11 16 10);

my $Karkkainen = LCP::Karkkainen->new();


my $lcp = $Karkkainen->lcp(suftab => \@suftab,
                      string => \@strarr);

my $lcpstr = join(" ",@{$lcp});

ok( $lcpstr eq $output, "Karkkainen");
done_testing;
